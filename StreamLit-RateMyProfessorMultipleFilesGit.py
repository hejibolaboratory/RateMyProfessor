...
relativepath="."
githubpath="https://raw.githubusercontent.com/hejibolaboratory/RateMyProfessor/main/"
# how to read github csv file, see https://tidypython.com/pandas-read-csv-from-github/

#file_list=[relativepath+"\\"+"students%s.csv"%count for count in range(1,240)]
file_list=[githubpath+"/"+"students%s.csv"%count for count in range(1,10)]
